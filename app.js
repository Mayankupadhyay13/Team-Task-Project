    ...
    <section class="auth-page">
      <div class="auth-panel">
        <div class="auth-copy">
          ...
          <h1>Command work without the clutter</h1>
          <p>A focused workspace for projects, assignments, owners, and delivery status. Admins shape the work; members keep progress moving.</p>
    ...
    <section class="shell">
      <aside class="sidebar">
        <div class="brand">
          ...
          <span>Work planning console</span>
        </div>
        <nav class="nav">
  ...
  layout(`
    <div class="topbar">
      <div>
        ...
        <p class="muted">A fast read on active work, momentum, and overdue pressure.</p>
      </div>
      <button class="btn primary" data-view="tasks">Open Tasks</button>
    </div>
    <section class="stats">
    ...
    <section class="panel focus-panel">
      <div class="panel-head">
        <div>
          ...
          <p class="muted">Completion, backlog, and movement at a glance.</p>
        </div>
    ...
    <section class="panel">
      <div class="panel-head">
        <div>
          <h2>Recent Tasks</h2>
          <p class="muted">The newest assignments visible to your role.</p>
        </div>
      </div>
...
function projectsView() {
  layout(`
    <div class="topbar">
      <div>
        <h1>Projects & Crew</h1>
        <p class="muted">${isAdmin() ? "Create project spaces and decide who belongs in each one." : "Review the project spaces connected to your account."}</p>
      </div>
    </div>
    <section class="grid">
      <form class="panel ${isAdmin() ? "" : "hidden"}" id="projectForm">
        <div class="panel-head"><h2>New Project Space</h2></div>
      ...
      <section class="panel">
        <div class="panel-head">
          <div>
          <h2>Projects</h2>
            <p class="muted">${state.projects.length} available workspace${state.projects.length === 1 ? "" : "s"}</p>
          </div>
        </div>
...
function tasksView() {
  layout(`
    <div class="topbar">
      <div>
        <h1>Task Flow</h1>
        <p class="muted">${isAdmin() ? "Create assignments, set ownership, and steer every task through status." : "Update the status of work assigned to you."}</p>
      </div>
    </div>
    ...
    <section class="grid">
      <form class="panel ${isAdmin() ? "" : "hidden"}" id="taskForm">
        <div class="panel-head"><h2>New Assignment</h2></div>
